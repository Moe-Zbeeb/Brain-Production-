...
from langchain_community.vectorstores import FAISS  # Use FAISS instead of Pinecone
...
class ChatBot:
    ...
    def train(self, file_paths):
        ...
        # Use the correct attribute `page_content` instead of `content`
        documents = [Document(page_content=doc.page_content, metadata=doc.metadata) for doc in self.split_docs]
...
# Create an instance of ChatBot and train it with a sample PDF
math201 = ChatBot("FEA520")
math201.train(["C1_W2.pdf"])

# Ask a question to the ChatBot
response = math201.ask_question("What is FIFA?")
print(response)
