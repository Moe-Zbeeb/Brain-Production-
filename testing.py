...
math201 = ChatBot("database")
import os
print(os.environ.get('PINECONE_API_KEY'))
#math201.train("C:\\Users\\bazzzyy\\OneDrive - American University of Beirut\\Desktop\\Dataset.pdf")
print(math201.ask_question("what is smog?"))
